...
- [`CrowdStrike Falcon`]():
  Acted as the primary analysis tool. Used the Sandboxing feature in Falcon to analyse the email atatchments and URL's. The "sandbox" is a secure, contained virtual space that mimics a real operating system but is cut off from the production environment, preventing any malicious actions from spreading or causing harm.
...
- [`Windows`](https://www.microsoft.com/en-ca/software-download/windows10) Virtual Machine:Acted as the primary analysis machine. Used to open and investigate live phishing email samples, inspect links and attachments, and perform forensic tasks using built-in and custom tools.

---

### Step 2: Download `Phishing Email` Samples to Windows
